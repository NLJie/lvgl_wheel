...
static char *cities[] = {"beijing", "shanghai", "guangzhou", "shenzhen", "tianjin", "chongqing", 
                        "chengdu", "wuhan", "nanjing", "hangzhou", "suzhou", "qingdao", "dalian", 
                        "ningbo", "xiamen", "fuzhou", "changsha", "nanning", "xian", "shenyang", 
                        "jinan", "haerbin", "changchun", "nanchang", "hefei", "zhengzhou", "shijiazhuang", 
                        "taiyuan", "huhehaote", "kunming", "guiyang", "nanning", "haikou", "lanzhou", "yinchuan", "wulumuqi"};
